...
def table_image():
    if request.method =='POST':
        ...
        print(get_rotation_angle(full_image))
        ...
        full_image = Image.fromarray(rotated)
        

        coordinates_lis = table_detect(full_image)
...
def calculate_iou(cell,span):
    ...
    Parameters:
    - cell: A list of four integers representing the coordinates of the first bounding box. The coordinates are in the format [xmin, ymin, xmax, ymax].
    - span: A list of four integers representing the coordinates of the second bounding box. The coordinates are in the format [xmin, ymin, xmax, ymax].

    Returns:
    - iou: A float representing the IoU between the two bounding boxes. The IoU is calculated as the ratio of the intersection area to the union area of the two bounding boxes.
